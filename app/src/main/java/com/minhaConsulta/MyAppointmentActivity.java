				...
				public boolean onItemLongClick(AdapterView<?> parent,
					...
					// TODO Auto-generated method stub
					 AlertDialog.Builder builder = new AlertDialog.Builder(MyAppointmentActivity.this);
				        builder.setMessage(getResources().getString(R.string.message_cancle_appointment))
	...
	public class loadNewsTask extends AsyncTask<Boolean, Void, ArrayList<HashMap<String, String>>> {
		...
		protected ArrayList<HashMap<String, String>> doInBackground(
			...
			try {
				...
				{
					json = jParser.getJSONFromUrl(ConstValue.JSON_MY_APPOINTMENT+"&user_id="+settings.getString("user_id",""));
					if (json.has("data")) {
